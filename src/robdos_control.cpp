...
//////////////////////////////////LOCALIZATION GPS///////////////////////////////////////////
float xCurrentPosition = 0, CurrentPosition = 0, zCurrentPosition = 0;
void localizationMessage(const geometry_msgs::PoseStamped& localizationCurrent){
  //http://docs.ros.org/api/geometry_msgs/html/msg/PoseStamped.html
  xCurrentPosition = localizationCurrent.pose.position.x;
  yCurrentPosition = localizationCurrent.pose.position.y;
  zCurrentPosition = localizationCurrent.pose.position.z;
}
...
////////////////////////////////////CONTROL WAYPOINTS/////////////////////////////////////////
    ...
    else if (k_output_Right<1100){k_output_Right = 1900}
    if(k_output_Left<1100){k_output_Left = 1100}
    else if (k_output_Left<1100){k_output_Left = 1900}
    
    rc_out.channels[0] = k_output_Right;
    rc_out.channels[0] = k_output_Left;
